...
//		0620
		friendPhoto = intent.getByteArrayExtra("friendPhoto");
//		0620
		initViews();
		initEvents();
	}
	...
	protected void initEvents() {
		...
		chatMessageAdapter = new ChatMessageAdapter(ChatActivity.this,chatList,friendPhoto);
...
//				chatMessage.setFriendPhoto(friendPhoto);
