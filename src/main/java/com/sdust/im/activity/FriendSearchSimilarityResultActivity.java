...
import com.sdust.im.adapter.FriendSearchSimilarityResultAdapter;
...
public class FriendSearchSimilarityResultActivity extends Activity{
	...
	private void initEvent() {
		...
		mListviewOfResults.setAdapter(new FriendSearchSimilarityResultAdapter(FriendSearchSimilarityResultActivity.this,mFriendList));
		...
		mListviewOfResults.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
						FriendSearchSimilarityResultActivity.this);
