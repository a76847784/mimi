		...
		case PhotoUtils.INTENT_REQUEST_CODE_ALBUM:
			...
			if (resultCode == RESULT_OK) {
				...
				if (cursor != null) {
					...
					Log.w("index",new Integer(column_index).toString());
...
//					Log.w("bitmap",bitmap.toString());
	...
	private RegisterStep initStep() {
		...
		case 1:
			...
			mHeaderLayout.setTitleRightText("注册新账号", null, "1/4");
		...
		case 2:
			...
			mHeaderLayout.setTitleRightText("设置密码", null, "2/4");
		...
		case 3:
			...
			mHeaderLayout.setTitleRightText("填写基本资料", null, "3/4");
			mBtnPrevious.setText("上一步");
			mBtnNext.setText("下一步");
...
//			0616
		case 4:
			if (mStepPhoto == null) {
				mStepPhoto = new StepPhoto(this, mVfFlipper.getChildAt(3));
			}
			mHeaderLayout.setTitleRightText("设置头像", null, "4/4");
			mBtnPrevious.setText("上一步");
			mBtnNext.setText("注    册");
			mStepPhoto.setAccount(getAccount());
			mStepPhoto.setName(getName());
			mStepPhoto.setID(getID());
