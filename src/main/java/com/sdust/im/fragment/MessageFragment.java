...
public class MessageFragment extends Fragment implements RemoveListener {
	...
	private void init() {
		...
		adapter = new FriendMessageAdapter(mContext, mMessageEntityList,mFriendList);
		...
		mMessageListView
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						mPosition = position;
						Log.w("MessageType",chooseMessageEntity.getMessageType()+"");
						if (chooseMessageEntity.getMessageType() == MessageTabEntity.MAKE_FRIEND_REQUEST)
							...
							for (User user:mFriendList ) {
								if (user.getId()==chooseMessageEntity.getSenderId()){
									intent.putExtra("friendPhoto",user.getPhoto());
									break;
								}
							}
