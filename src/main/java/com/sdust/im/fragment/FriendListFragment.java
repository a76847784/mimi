...
import com.sdust.im.activity.SearchFriendOptionActivity;
...
//		adapter = new FriendSearchResultAdapter(mContext, mFriendList);
...
//				0620
				intent.putExtra("friendPhoto", friend.getPhoto());
//				0620
		...
		mTitleBarView.setBtnRightOnclickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(mContext, SearchFriendOptionActivity.class);
				startActivity(intent);
			}
		});
