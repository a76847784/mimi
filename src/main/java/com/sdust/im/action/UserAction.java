...
public class UserAction {
	...
	public static void searchFriendSimilarity(User user, byte[] photoByte) throws IOException {
		user.setPhoto(photoByte);
		Log.i("user",user.toString());
		TranObject t = new TranObject(user, TranObjectType.SEARCH_FRIEND_SIMILARITY);
		mNetService.send(t);
